...
function setupAgreement(){
  ...
  function upd(){ const c=items.filter(cb=>cb.checked).length; agreeAll.checked=c===items.length; agreeAll.indeterminate=c>0&&c<items.length; }
