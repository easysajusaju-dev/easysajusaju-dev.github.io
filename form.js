// form.js (결제 연동 - PG 테스트까지 완료할 버전)
const pageLoadTime = new Date();
const APPS_SCRIPT_URL = "https://script.google.com/macros/s/AKfycbz_SRAMhhOT396196sgEzHeDMNk_oF7IL-M5BpAReKum04hVtkVYw0AwY71P4SyEdm-/exec"; // ★ 기존 신청 저장 URL (건드리지 않음)

// ★ 새로 만든 결제 생성 웹앱 URL로 교체 (매우 중요!)
...
document.addEventListener('DOMContentLoaded', ()=>{
  ...
  formEl.addEventListener('submit', async (event)=>{
    ...
    try{
      ...
      const orderId='EZ'+Date.now(); data['오더ID']=orderId; // 오더ID 생성 (로그용)
